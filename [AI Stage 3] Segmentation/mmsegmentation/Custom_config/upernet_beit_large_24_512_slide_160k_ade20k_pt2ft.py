# python tools/train.py configs/my_config/upernet_beit_large_24_512_slide_160k_ade20k_pt2ft.py
_base_ = [
    './models/upernet_beit.py', './datasets/dataset.py',
    './default_runtime.py', './schedules/schedule.py'
]

model = dict(
    pretrained='configs/my_config/pretrain/beit_large_patch16_224_pt22k_ft22k.pth',
    backbone=dict(
        type='BEiT',
        img_size=512,
        embed_dims=1024,
